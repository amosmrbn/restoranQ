...
if(isset($_POST['submit'])){
    ...
    try {
        if($id){ 
            $sql = "UPDATE receipts set name='$name', username='$username', password='$password' WHERE id=$id";
        }else{
            $sql = "INSERT INTO receipts(name, username, password) VALUE ('$name', '$username', '$password') ";
        }
